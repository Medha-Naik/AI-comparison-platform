...
def remove_from_wishlist():
    ...
    try:
        ...
        if 'wishlist_item_id' not in data:
            return jsonify({"success": False, "message": "Missing required field: wishlist_item_id"}), 400
...
def update_target_price():
    ...
    try:
        ...
        if 'wishlist_item_id' not in data or 'target_price' not in data:
...
# ✅ FIXED HERE: allow product_name with slashes, spaces, etc.
@wishlist_bp.route('/wishlist/check/<path:product_name>', methods=['GET'])
